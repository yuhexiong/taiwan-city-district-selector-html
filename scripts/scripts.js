var cities = ["請選擇", "臺北市", "新北市", "基隆市", "桃園市", "新竹市", "新竹縣", "宜蘭縣", "苗栗縣", "臺中市", "彰化縣", "南投縣", "雲林縣", "嘉義市", "嘉義縣", "臺南市", "高雄市", "屏東縣", "花蓮縣", "臺東縣", "澎湖縣", "金門縣", "連江縣"]
function writeCity() {
  var c = "";
  for (let i = 0; i < cities.length; i++) {
    c += `<option value=" ${i}">${cities[i]}`;
  }
...
function writeDistrict() {
  ...
  var idx = parseInt(city.value);
  for (let i = 0; i < districts[idx].length; i++) {
    d += `<option value=" ${i}">${districts[idx][i]}`;
  }
